document.addEventListener('DOMContentLoaded', () => {
    ...
    // 6. Form Submission Handlers (Netlify Forms Integration)
    ...
    if (contactForm) {
        contactForm.addEventListener('submit', (e) => {
            ...
            // Prepare form data for Netlify Forms AJAX
            ...
            .then(response => {
                ...
                if (response.ok) {
                    ...
                    alertBox.innerHTML = '<i class="fas fa-check-circle"></i> Thank you! Your booking request has been submitted successfully to Netlify. We will contact you shortly.';
                    contactForm.reset();
                } else {
